 ...
 *
 * Bundle contents:
 *     [0] RSA-2048        CN=Amazon Root CA 1,O=Amazon,C=US
 *     [1] RSA-2048        CN=Baltimore CyberTrust Root,OU=CyberTrust,O=Baltimore,C=IE
 *     [2] RSA-2048        CN=DigiCert Global Root CA,OU=www.digicert.com,O=DigiCert Inc,C=US
 *     [3] RSA-2048        CN=DigiCert Global Root G2,OU=www.digicert.com,O=DigiCert Inc,C=US
 *     [4] EC-secp384r1    CN=DigiCert Global Root G3,OU=www.digicert.com,O=DigiCert Inc,C=US
 *     [5] RSA-4096        CN=GTS Root R1,O=Google Trust Services LLC,C=US
 *     [6] EC-secp384r1    CN=GTS Root R4,O=Google Trust Services LLC,C=US
 *     [7] RSA-4096        CN=ISRG Root X1,O=Internet Security Research Group,C=US
 *     [8] EC-secp384r1    CN=ISRG Root X2,O=Internet Security Research Group,C=US
 *     [9] EC-secp384r1    CN=SSL.com TLS ECC Root CA 2022,O=SSL Corporation,C=US
 *     [10] RSA-4096        CN=USERTrust RSA Certification Authority,O=The USERTRUST Network,L=Jersey City,ST=New Jersey,C=US
 * ========================================================== */

#include "../lib/bearssl/inc/bearssl_x509.h"

// --- [0] CN=Amazon Root CA 1,O=Amazon,C=US (from AmazonRootCA1.pem) ---
...
// --- [1] CN=Baltimore CyberTrust Root,OU=CyberTrust,O=Baltimore,C=IE (from BaltimoreCyberTrustRoot.pem) ---
...
// --- [2] CN=DigiCert Global Root CA,OU=www.digicert.com,O=DigiCert Inc,C=US (from DigiCertGlobalRootCA.pem) ---
...
// --- [3] CN=DigiCert Global Root G2,OU=www.digicert.com,O=DigiCert Inc,C=US (from DigiCertGlobalRootG2.pem) ---
...
// --- [4] CN=DigiCert Global Root G3,OU=www.digicert.com,O=DigiCert Inc,C=US (from DigiCertGlobalRootG3.pem) ---
...
// --- [5] CN=GTS Root R1,O=Google Trust Services LLC,C=US (from GTSRootR1.pem) ---
...
// --- [6] CN=GTS Root R4,O=Google Trust Services LLC,C=US (from GTSRootR4.pem) ---
...
// --- [7] CN=ISRG Root X1,O=Internet Security Research Group,C=US (from isrgrootx1.pem) ---
...
// --- [8] CN=ISRG Root X2,O=Internet Security Research Group,C=US (from ISRGRootX2.pem) ---
...
// --- [9] CN=SSL.com TLS ECC Root CA 2022,O=SSL Corporation,C=US (from SSLcomTLSECCRoot2022.pem) ---
...
// --- [10] CN=USERTrust RSA Certification Authority,O=The USERTRUST Network,L=Jersey City,ST=New Jersey,C=US (from USERTrustRSA.pem) ---
...
const br_x509_trust_anchor ai_os_trust_anchors[] = {
	{
...
const unsigned int ai_os_trust_anchors_num = sizeof ai_os_trust_anchors / sizeof ai_os_trust_anchors[0];
