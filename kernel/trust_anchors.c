 ...
 *     [9] RSA-4096        CN=USERTrust RSA Certification Authority,O=The USERTRUST Network,L=Jersey City,ST=New Jersey,C=US
 * ========================================================== */
...
// --- [9] CN=USERTrust RSA Certification Authority,O=The USERTRUST Network,L=Jersey City,ST=New Jersey,C=US (from USERTrustRSA.pem) ---
